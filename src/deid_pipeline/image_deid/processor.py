...
from ..pii.detectors.composite import CompositeDetector, DetectorConfig
from ..pii.utils.replacer import Replacer
from ..pii.utils.fake_provider import FakeProvider
from ..pii.utils.base import Entity
...
class ImageDeidProcessor:
    ...
    def process_image(
        ...
        try:
            ...
            # 2. 抽取文字和版面資訊
            extraction_result = self.text_extractor.extract(image)
